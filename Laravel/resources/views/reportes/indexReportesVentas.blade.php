    ...
    <div class="col-md-6">
      <div class="box box-default">
        ...
        <div class="box-body">
          ...
          <!-- <form class="form-horizontal" id="formCreateReporteVentas">@csrf -->
            <div class="box-body">
...
<div class="modal fade" id="md_view_reporte" tabindex="-1" >
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-body" >
              <div  id="view_reporte" ></div>
            </div>
...
@section('scrípt')
<!-- PDF create -->
<script src="{{ asset('plantilla/jsPDF/dist/jspdf.debug.js') }}"></script>
<script src="{{ asset('plantilla/jsPDF/libs/html2pdf.js') }}"></script>
<script>
