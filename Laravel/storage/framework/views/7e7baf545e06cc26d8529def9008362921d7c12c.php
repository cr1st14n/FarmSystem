...
<div class="modal fade" id="modal-regisUser">
  <form role="form" action="<?php echo e(route('crear-usuario')); ?> " method="post">
    <?php echo csrf_field(); ?>
...
<script src="<?php echo e(asset('asincrono/users.js')); ?>"></script>

<?php if($editModal == 1): ?>
<script type="text/javascript">
  $(document).ready(function() {
    $("#modal-actualizatUser").modal("show");
    $('#cargo > option[value=<?php echo e($usuario->usu_cargo); ?>]').attr('selected', 'selected');
  });
</script>
<?php endif; ?>
<?php $__env->stopSection(); ?>
