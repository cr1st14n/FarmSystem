                                ...
                                <div class="col-lg-12">
                                    <div class="input-group margin">
                                        ...
                                        <select class="form-control" name="" id="" onchange="filtArtProve(this.value)">
                                            ...
                                            <?php $__currentLoopData = $provs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pro): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($pro->id); ?>"><?php echo e($pro->prov_nombre); ?></option>
                    ...
                    <div class="row">
                        <div class="col-md-7">
                            ...
                            <div class="box box-info">
                                ...
                                <form class="form-horizontal" id="form-updateArt"><?php echo e(csrf_field()); ?>
                            ...
                            <div class="form-group">
                                <select class="form-control select2" name="proveedor" id="art_proveedor" style="width: 100%;" required="">
                                    ...
                                    <?php $__currentLoopData = $provs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $prov): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($prov->id); ?> " ><?php echo e($prov->prov_nombre); ?> / <?php echo e($prov->prov_direccion); ?> </option>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </select>
                            </div>
                            <div class="row">
...
<?php $__env->startSection('scrípt'); ?>
    ...
    <script src="<?php echo e(asset('asincrono/artinv.js')); ?>"></script>
    <!-- DataTables -->
